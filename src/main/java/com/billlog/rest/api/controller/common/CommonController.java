package com.billlog.rest.api.controller.common;

import com.billlog.rest.api.mapper.CommonMapper;
...
public class CommonController {
    ...
    @ApiOperation(value = "도시 조회", notes = "모든 도시(City)를 조회한다")
    @GetMapping(value = "/citys")
    public ListResult<FoodCity> getCitys() {
