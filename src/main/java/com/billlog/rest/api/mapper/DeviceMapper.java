...
public interface DeviceMapper {
    ...
    @Select(" SELECT device.device_token " +
            " FROM food_user user " +
            " INNER JOIN food_community community ON user.user_idx = community.writer_user_idx " +
            " LEFT JOIN food_device device ON user.user_id = device.user_id " +
